...
public interface Constants {
    ...
    /**
     * 取现基数（USDT），取现值必须是基数的倍数，基数如果是 100，那么取现值只能是 100 的倍数，例如：200,
     * 300 等
     */
    ...
    /**
     * 币币交易 K 线 redis 存储 Key
     */
    String REDIS_KEY_TRADE_KLINE = "TRADE_KLINE:";
    /**
     * 币币交易撮合队列 redis 存储 Key
     */
     ...
     * 内置token
     */
    String INSIDE_TOEKN = "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJzY29wZSI6WyJhbGwiXSwiZXhwIjozNzc3NjA5MDYwLCJqdGkiOiJiMTk5ZDAyOS0wNGZlLTQ1YTctODEwOC1iMzgwY2JiMDQ3NjMiLCJjbGllbnRfaWQiOiJpbnNpZGVfYXBwIn0.CIlSp0qXHPs1FOSGKxGKwbcbOPfKHxP6x6NtBb1kX0n-I85CZAyNot0k_VHLHH09dSx4sXEEXV9GEmwhNVbUaFiiinwYiFZeyAmmpNxIxB6BZUQpDZwrzrnFzgQP-R3uIfNsvofe4tlkw1TJRJRWUffeq3TMzZj-JaiJw7nDWXDu7aVCOYomx_dq08RG6xhtBhn4XPM6ReEuZTF4iduDE5AlHJQRiyKeFaRH9AJ2xlI4sKvZ0CXLMWySmEHqCq2klL15z7EXOkAiLsMYtr5sx3tvmekFoDiPtK5yAXvbmSaKBTSvxAK8YIMhwHrumXU7xYNGRDnEbxrvdxcuA_oJ3A";
